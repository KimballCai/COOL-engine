  ...
  public void testSaveLoad() {
    ...
    try {
      ...
      StorageService storageService =
          new HdfsStorageService("hdfs://<host>:<port>", "/user/hdfs/", new Configuration());
      ...
      Assert.fail("Failed to connect to to hdfs service" + "at local host port 20131\n");
    }
    try {
      dummyFile.delete();
      ...
      Assert.fail(
          "Failed to garbage clean dummy files for testing" + "please remove them manually\n");
    }
  }
}
