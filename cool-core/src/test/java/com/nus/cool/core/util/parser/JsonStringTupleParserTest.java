  ...
  public void testParse() {
    String schemaString =
        "charset: \"UTF-8\"\n"
            ...
            + "  preCal: false\n";
    try {
      InputStream in = new ByteArrayInputStream(schemaString.getBytes("UTF-8"));
      TableSchema schema = TableSchema.read(in);
      String recordToParse =
          "{\"sessionId\":\"fd1ec667\","
              + "\"int64_field\":\"64\","
              + "\"role\":\"stonegolem\","
      ...
      Assert.assertEquals(ret[6], "Int96Value{Binary{3 constant bytes, [0, 0, 0]}}");
    } catch (IOException e) {
