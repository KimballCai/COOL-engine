...
public class CsvLoaderTest {
  ...
  public void CsvLoaderUnitTest(
      String cube, String schemaFileName, String dataFileName, String cubeRepo) throws IOException {
  ...
  public void CsvLoaderFailUnitTest(
      String cube, String schemaFileName, String dataFileName, String cubeRepo) throws IOException {
    DataLoaderConfig config = new CsvDataLoaderConfig();
    CoolLoader loader = new CoolLoader(config);
    loader.load(cube, schemaFileName, dataFileName, cubeRepo);
  ...
  //     public void CsvLoaderConsistencyUnitTest(String cube, String schemaFileName, String
  // dataFileName, String cubeRepo)
  //             throws IOException {
  //         DataLoaderConfig config = new CsvDataLoaderConfig();
  //         CoolLoader loader = new CoolLoader(config);
  //         loader.load(cube, schemaFileName, dataFileName, cubeRepo);
