...
/**
 * Storage Service defines external file storage services that can be connected to COOL for loading
 * and storing data.
 *
 * <p>This allows offloading the responsibility of availability, persistence, fault tolerance of
 * data to the storage service.
 */
public interface StorageService {
  ...
  /**
   * Compared to loadData, the destDir is expected to follow the cube directory organization. This
   * allows only more efficient implementation. (for example only loading the new versions of a
   * cube)
   *
  ...
  /**
   * Compared to storeData, the srcDir is expected to follow the cube directory organization. This
   * allows more efficient implementation customized for COOL cube.
   *
   * @param cube : name for the cube in storage service
   * @param srcDir : path to the cube to store
   */
