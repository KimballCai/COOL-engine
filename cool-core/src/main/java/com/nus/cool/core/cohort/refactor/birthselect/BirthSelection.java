...
public class BirthSelection {
  ...
  /**
   * If user's birthEvent is selected, Get the birthEvent's Date. If cohort query requires a
   * collection of event we take the first event in whole collection as user's birthEvent
   *
   * @param userId
   * @return
   */
  ...
  /**
   * Select input Action Tuple, if it can not be selected as event return false Else return true and
   * add this event into BirthSelectionContext for further check.
   *
   * @param userId
   * @param date
