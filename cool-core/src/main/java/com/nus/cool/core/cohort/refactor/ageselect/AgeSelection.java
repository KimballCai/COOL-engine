...
public class AgeSelection {
   ...
   * @param birthDate
   * @param actionTime
   * @return if the age is out of range return -1 else return age TODO(lingze): Long to int will
   *     raise loss of precision, future implementation should focus on long type data.
   */
