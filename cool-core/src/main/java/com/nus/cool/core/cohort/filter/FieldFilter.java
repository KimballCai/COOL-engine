...
/**
 * FieldFilter is used as a filter of the fields, especially useful when setting up the birth
 * condition and other selections.
 */
public interface FieldFilter {
   ...
   * @return false indicates the interger is not eligible and true indicates the interger is
   *     eligible
   */
