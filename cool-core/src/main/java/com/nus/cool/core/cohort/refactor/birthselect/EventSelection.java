...
/**
 * EventSelection is a collection of filters if one data item pass all filters in this Event X's
 * eventSelection it can be selected as Event X. json mapper to constuct EventSelection
 */
public class EventSelection {
  // a list of filter, which generated by filter layout
  @JsonIgnore @Getter private final List<Filter> filterList;
