 ...
 *
 * <p>See <a href="http://java.sun.com/j2se/1.4.2/docs/api/index.html">here</a> for details on how
 * to use MessageDigest objects.
 *
 * <p>Note: in order to use the {@link java.security.MessageDigest} algorithms provided by this
